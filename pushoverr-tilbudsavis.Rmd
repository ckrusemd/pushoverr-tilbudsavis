...
```{r}
df_etilbudsavisen %>% filter(keyword=="bilka") %>% arrange(heading) %>%   DT::datatable(.,filter="top")
```

### Netto

```{r}
df_etilbudsavisen %>% filter(keyword=="netto") %>% arrange(heading) %>%   DT::datatable(.,filter="top")
```

### Rema 1000

```{r}
df_etilbudsavisen %>% filter(keyword=="rema") %>% arrange(heading) %>%   DT::datatable(.,filter="top")
```

### Coop365

```{r}
df_etilbudsavisen %>% filter(keyword=="coop") %>% arrange(heading) %>%   DT::datatable(.,filter="top")
```

### Meny

```{r}
df_etilbudsavisen %>% filter(keyword=="meny") %>% arrange(heading) %>%   DT::datatable(.,filter="top")
```

### Harald Nyborg

```{r}
df_etilbudsavisen %>% filter(keyword=="nyborg") %>% arrange(heading) %>%   DT::datatable(.,filter="top")
```
...
```{r}
df_etilbudsavisen %>% filter(keyword=="skyr") %>% arrange(price_per_kg) %>%   DT::datatable(.,filter="top")
```

### Oksekød

```{r}
df_etilbudsavisen %>% filter(keyword=="oksekød") %>% arrange(price_per_kg) %>%  DT::datatable(.,filter="top")
```
### Neutral

```{r}
df_etilbudsavisen %>% filter(keyword %in% c("neutral")) %>%  arrange(price_per_kg) %>% DT::datatable(.,filter="top")
```
### Tabs

```{r}
df_etilbudsavisen %>% filter(keyword %in% c("tabs")) %>%  arrange(price_per_kg) %>% DT::datatable(.,filter="top")
```

### Tun

```{r}
df_etilbudsavisen %>% filter(keyword %in% c("tun")) %>%  arrange(price_per_kg) %>% DT::datatable(.,filter="top")
```

### Slik

```{r}
df_etilbudsavisen %>% filter(keyword %in% c("slik")) %>%  arrange(price_per_kg) %>% DT::datatable(.,filter="top")
```

### Legetøj

```{r}
df_etilbudsavisen %>% filter(keyword %in% c("lego","switch","playstation","ps5")) %>%  arrange(price_per_kg) %>% DT::datatable(.,filter="top")
```

### Sodavand

```{r}
df_etilbudsavisen %>% filter(keyword %in% c("cola","pepsi","sodavand")) %>%  arrange(price_per_kg) %>% DT::datatable(.,filter="top")
```

### Kaffe

```{r}
df_etilbudsavisen %>% filter(keyword %in% c("kaffe","starbucks")) %>%  arrange(price_per_kg) %>% DT::datatable(.,filter="top")
```
...
```{r}
df_etilbudsavisen %>% filter(keyword %in% c("burger")) %>%  arrange(price_per_kg) %>% DT::datatable(.,filter="top")
```

### Pølser

```{r}
df_etilbudsavisen %>% filter(keyword %in% c("pølser")) %>%  arrange(price_per_kg) %>% DT::datatable(.,filter="top")
```
